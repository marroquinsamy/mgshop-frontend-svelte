...
var app = (function () {
    ...
    const file$6 = "src/components/ErrorPage.svelte";
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-122egor");
    			add_location(button, file$6, 20, 4, 636);
    			attr_dev(div, "class", "button-container svelte-122egor");
    			add_location(div, file$6, 19, 2, 601);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block) if_block.c();
    			if_block_anchor = empty();
    			if (img.src !== (img_src_value = "/images/" + /*imageName*/ ctx[2] + ".svg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Ilustración de error");
    			attr_dev(img, "class", "svelte-122egor");
    			add_location(img, file$6, 15, 5, 439);
    			attr_dev(div, "class", "svelte-122egor");
    			add_location(div, file$6, 15, 0, 434);
    			attr_dev(h2, "class", "products-page--page-title svelte-122egor");
    			add_location(h2, file$6, 16, 0, 510);
    			attr_dev(p, "class", "svelte-122egor");
    			add_location(p, file$6, 17, 0, 561);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*imageName*/ 4 && img.src !== (img_src_value = "/images/" + /*imageName*/ ctx[2] + ".svg")) {
    				attr_dev(img, "src", img_src_value);
    			}
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("description" in $$props) $$invalidate(1, description = $$props.description);
    		if ("code" in $$props) $$invalidate(5, code = $$props.code);
    		if ("imageName" in $$props) $$invalidate(2, imageName = $$props.imageName);
    	};
    	...
    	return [title, description, imageName, showButton, navigate, code, click_handler];
    }

    class ErrorPage extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { title: 0, description: 1, code: 5 });
    		...
    		if (/*code*/ ctx[5] === undefined && !("code" in props)) {
    			console.warn("<ErrorPage> was created without expected prop 'code'");
    		}
    	}
    ...
    function create_catch_block(ctx) {
    	...
    	errorpage = new ErrorPage({
    			props: {
    				code: /*error*/ ctx[9].message.split(errorSeparator$1)[0],
    				title: /*error*/ ctx[9].message.split(errorSeparator$1)[1],
    				description: /*error*/ ctx[9].message.split(errorSeparator$1)[2]
    			},
    			$$inline: true
    		});
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "products-page--page-title");
    			add_location(h2, file$7, 39, 2, 1820);
    			attr_dev(div, "class", "svelte-tei2fq");
    			add_location(div, file$7, 40, 2, 1893);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_catch_block$1(ctx) {
    	...
    	errorpage = new ErrorPage({
    			props: {
    				code: /*error*/ ctx[4].message.split(errorSeparator$2)[0],
    				title: /*error*/ ctx[4].message.split(errorSeparator$2)[1],
    				description: /*error*/ ctx[4].message.split(errorSeparator$2)[2]
    			},
    			$$inline: true
    		});
    ...
    function create_then_block$1(ctx) {
    	let h2;
    	let t0_value = /*product*/ ctx[3].title + "";
    	let t0;
    	let registerFocus_action;
    	let t1;
    	let p0;
    	let t2_value = /*product*/ ctx[3].description + "";
    	let t2;
    	let t3;
    	let p1;
    	let t4;
    	let t5_value = /*product*/ ctx[3].price + "";
    	let t5;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = text(t5_value);
    			attr_dev(h2, "class", "products-page--page-title");
    			add_location(h2, file$8, 14, 2, 431);
    			add_location(p0, file$8, 15, 2, 510);
    			add_location(p1, file$8, 16, 2, 541);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    			append_dev(h2, t0);
    ...
    const file$9 = "src/Products/components/Cart.svelte";
    ...
    // (5:0) <Route meta={{ viewName: 'página no encontrada' }}>
    function create_default_slot$3(ctx) {
    	...
    	errorpage = new ErrorPage({
    			props: {
    				...
    				description: "Parece que nos has solicitado una página que no existe. Haz click en el botón\n  para darte una vuelta por nuestro catálogo y hacer tu primera compra con\n  nosotros.",
    				code: "001"
    			},
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(5:0) <Route meta={{ viewName: 'página no encontrada' }}>",
    		ctx
    	});
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Route, ErrorPage });
    	return [];
    }
    ...
    const file$a = "src/Products/Products.svelte";
    ...
    function create_default_slot$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$a, 12, 2, 381);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a2, file$b, 53, 4, 1522);
    			attr_dev(section1, "class", "developer-credits svelte-1ood148");
    			add_location(section1, file$b, 48, 2, 1327);
    			attr_dev(footer, "class", "svelte-1ood148");
    			add_location(footer, file$b, 35, 0, 965);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$c, 9, 2, 397);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(route0, div, null);
