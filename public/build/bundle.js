...
var app = (function () {
    ...
    const getProducts = async () => {
        ...
        try {
            ...
            console.log(error);
            throw new Error('000$$$Hubo un error obteniendo los productos$$$Intenta de nuevo más tarde o ponte en contacto con nosotros mediante nuestras redes sociales.');
        }
        if (res.status === 204)
            throw new Error('204$$$¡Ups! Parece que olvidamos algo$$$Comunícate con nosotros para verificar la disponibilidad de nuestros productos.');
        else if (res.ok) {
    ...
    const getProduct = async (id) => {
        ...
        if (res.ok) {
            ...
            throw new Error('404$$$Parece que alguien no vino a trabajar hoy$$$No hemos encontrado el item que estás buscando. Haz click en el botón para explorar nuestro catálogo de productos.');
        else
            throw new Error('000$$$Hubo un error obteniendo el producto que nos solicitaste$$$Intenta de nuevo más tarde o ponte en contacto con nosotros mediante nuestras redes sociales.');
    };
    ...
    function create_default_slot$4(ctx) {
    	...
    	route2 = new Route({
    			props: {
    				...
    				meta: { name: "Página no encontrada" }
    			},
    			$$inline: true
    		});
