...
var app = (function () {
    ...
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(i, "class", "bx bx-right-arrow-alt svelte-4hyy9h");
    			add_location(i, file$4, 21, 6, 665);
    			attr_dev(span, "class", "more-details-text svelte-4hyy9h");
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h3, "class", "svelte-4hyy9h");
    			add_location(h3, file$4, 9, 4, 252);
    			attr_dev(p, "class", "product-description svelte-4hyy9h");
    			...
    			attr_dev(img, "class", "svelte-4hyy9h");
    			add_location(img, file$4, 13, 4, 386);
    			attr_dev(div0, "class", "image-container svelte-4hyy9h");
    			add_location(div0, file$4, 12, 2, 352);
    			attr_dev(i, "class", "bx bxs-coin svelte-4hyy9h");
    			add_location(i, file$4, 17, 6, 500);
    			add_location(small, file$4, 18, 12, 538);
    			add_location(span, file$4, 18, 6, 532);
    			attr_dev(div1, "class", "price svelte-4hyy9h");
    			add_location(div1, file$4, 16, 4, 474);
    			attr_dev(footer, "class", "svelte-4hyy9h");
    			add_location(footer, file$4, 15, 2, 461);
    			attr_dev(article, "class", "svelte-4hyy9h");
    ...
    function create_catch_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$5, 40, 4, 1735);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(37:4) {#each products as product}",
    		ctx
    	});
    ...
    // (34:25)      <p>Cargando...</p>   {:then products}
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$5, 34, 4, 1606);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(34:25)      <p>Cargando...</p>   {:then products}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$5, 31, 0, 1517);
    			attr_dev(div, "class", "svelte-tzez1r");
    			add_location(div, file$5, 32, 0, 1570);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			h2 = element("h2");
    			h2.textContent = "Parece que alguien no vino a trabajar hoy...";
    			t2 = space();
    			p = element("p");
    			p.textContent = "No hemos encontrado el item que estás buscando. Haz click en el botón para\n  explorar nuestro catálogo de productos.";
    			t4 = space();
    			div1 = element("div");
    			button = element("button");
    			button.textContent = "¡Ir de compras!";
    			if (img.src !== (img_src_value = "/images/no-data.svg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Portapapeles sin datos");
    			attr_dev(img, "class", "svelte-lctsjf");
    			add_location(img, file$6, 4, 5, 114);
    			attr_dev(div0, "class", "svelte-lctsjf");
    			add_location(div0, file$6, 4, 0, 109);
    			attr_dev(h2, "class", "products-page--page-title svelte-lctsjf");
    			add_location(h2, file$6, 5, 0, 183);
    			attr_dev(p, "class", "svelte-lctsjf");
    			add_location(p, file$6, 8, 0, 275);
    			attr_dev(button, "class", "svelte-lctsjf");
    			add_location(button, file$6, 13, 2, 436);
    			attr_dev(div1, "class", "button-container svelte-lctsjf");
    			add_location(div1, file$6, 12, 0, 403);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_then_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t = text(t_value);
    			add_location(h1, file$7, 10, 2, 271);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$9 = "src/components/PageNotFound.svelte";
    ...
    const file$a = "src/Products/components/Footer.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a2, file$a, 18, 4, 527);
    			attr_dev(section1, "class", "developer-credits svelte-1ood148");
    			add_location(section1, file$a, 13, 2, 332);
    ...
    function create_default_slot$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$b, 13, 2, 433);
    		},
    		m: function mount(target, anchor) {
