...
var app = (function () {
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$3, 15, 6, 382);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(15:4) <Link to=\\\"/\\\" title=\\\"MGShop\\\">",
    		ctx
    	});
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$3, 22, 13, 614);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$3, 21, 8, 567);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    		},
    ...
    // (20:4) <Link class="navbar--link" to="./" title="Productos">
    function create_default_slot_1(ctx) {
    	let if_block_anchor;

    	function select_block_type(ctx, dirty) {
    		if (/*atProducts*/ ctx[1]) return create_if_block_1$1;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(20:4) <Link class=\\\"navbar--link\\\" to=\\\"./\\\" title=\\\"Productos\\\">",
    		ctx
    	});
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			i = element("i");
    			attr_dev(i, "class", "bx bx-cart-alt svelte-gzhfok");
    			add_location(i, file$3, 27, 13, 803);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    		},
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			i = element("i");
    			attr_dev(i, "class", "bx bxs-cart-alt svelte-gzhfok");
    			add_location(i, file$3, 26, 8, 760);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    		},
    ...
    // (25:4) <Link class="navbar--link" to="cart" title="Carrito de compras">
    function create_default_slot$1(ctx) {
    	let if_block_anchor;

    	function select_block_type_1(ctx, dirty) {
    		if (/*atCart*/ ctx[0]) return create_if_block$2;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(25:4) <Link class=\\\"navbar--link\\\" to=\\\"cart\\\" title=\\\"Carrito de compras\\\">",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			i = element("i");
    			add_location(div0, file$3, 13, 2, 337);
    			add_location(div1, file$3, 18, 2, 472);
    			attr_dev(i, "class", "bx bxs-chevron-down-circle svelte-gzhfok");
    			add_location(i, file$3, 32, 6, 906);
    			attr_dev(button, "title", "Más opciones");
    			attr_dev(button, "class", "svelte-gzhfok");
    			add_location(button, file$3, 31, 4, 870);
    			add_location(div2, file$3, 30, 2, 860);
    			attr_dev(nav, "class", "svelte-gzhfok");
    			add_location(nav, file$3, 12, 0, 329);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("atCart" in $$props) $$invalidate(0, atCart = $$props.atCart);
    		if ("atProducts" in $$props) $$invalidate(1, atProducts = $$props.atProducts);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$location, pathname*/ 24) {
    			 {
    				$$invalidate(3, pathname = $location.pathname);
    				$$invalidate(0, atCart = pathname.split("/")[2] === "cart" ? true : false);
    				$$invalidate(1, atProducts = pathname.split("/")[2] !== "cart" ? true : false);
    			}
    		}
    	};

    	return [atCart, atProducts, location, pathname, $location];
    }
    ...
    const API = 'http://192.168.0.106:4000';
    const errorSeparator = '$$$'; // Use this constant to separate the res status code, the error title and the error description
    const getProducts = async () => {
        ...
        try {
            ...
            console.log(error);
            throw new Error(`000${errorSeparator}Hubo un error obteniendo los productos${errorSeparator}Intenta de nuevo más tarde o ponte en contacto con nosotros mediante nuestras redes sociales.`);
        }
        if (res.status === 204)
            throw new Error(`204${errorSeparator}¡Ups! Parece que olvidamos algo${errorSeparator}Comunícate con nosotros para verificar la disponibilidad de nuestros productos.`);
        else if (res.ok) {
    ...
    const getProduct = async (id) => {
        ...
        try {
            ...
            console.log(error);
            throw new Error(`000${errorSeparator}Hubo un error obteniendo el producto que nos solicitaste${errorSeparator}Intenta de nuevo más tarde o ponte en contacto con nosotros mediante nuestras redes sociales.`);
        }
        if (res.ok) {
            ...
            throw new Error(`404${errorSeparator}Parece que alguien no vino a trabajar hoy${errorSeparator}No hemos encontrado el item que estás buscando. Haz click en el botón para explorar nuestro catálogo de productos.`);
        else
            throw new Error(`000${errorSeparator}Hubo un error obteniendo el producto que nos solicitaste${errorSeparator}Intenta de nuevo más tarde o ponte en contacto con nosotros mediante nuestras redes sociales.`);
    };
    ...
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			span = element("span");
    			span.textContent = "Más detalles";
    			attr_dev(i, "class", "bx bx-right-arrow-alt svelte-12lqd3q");
    			add_location(i, file$4, 21, 6, 665);
    			attr_dev(span, "class", "more-details-text svelte-12lqd3q");
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h3, "class", "svelte-12lqd3q");
    			add_location(h3, file$4, 9, 4, 252);
    			attr_dev(p, "class", "product-description svelte-12lqd3q");
    			...
    			attr_dev(img, "class", "svelte-12lqd3q");
    			add_location(img, file$4, 13, 4, 386);
    			attr_dev(div0, "class", "image-container svelte-12lqd3q");
    			add_location(div0, file$4, 12, 2, 352);
    			attr_dev(i, "class", "bx bxs-coin svelte-12lqd3q");
    			add_location(i, file$4, 17, 6, 500);
    			add_location(small, file$4, 18, 12, 538);
    			add_location(span, file$4, 18, 6, 532);
    			attr_dev(div1, "class", "price svelte-12lqd3q");
    			add_location(div1, file$4, 16, 4, 474);
    			attr_dev(footer, "class", "svelte-12lqd3q");
    			add_location(footer, file$4, 15, 2, 461);
    			attr_dev(article, "class", "svelte-12lqd3q");
    ...
    /* src/components/Button.svelte generated by Svelte v3.30.0 */
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span = element("span");
    			t = text(/*text*/ ctx[0]);
    			attr_dev(i, "class", i_class_value = "" + (null_to_empty(/*classes*/ ctx[1]) + " svelte-c5lnhn"));
    			add_location(i, file$6, 4, 17, 102);
    			add_location(span, file$6, 4, 38, 123);
    			attr_dev(button, "class", "svelte-c5lnhn");
    			add_location(button, file$6, 4, 0, 85);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*classes*/ 2 && i_class_value !== (i_class_value = "" + (null_to_empty(/*classes*/ ctx[1]) + " svelte-c5lnhn"))) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	let { text = "Haz click" } = $$props;
    	let { classes = "" } = $$props;
    	const writable_props = ["text", "classes"];
    	...
    	$$self.$capture_state = () => ({ text, classes });
    	...
    	return [text, classes, click_handler];
    }

    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { text: 0, classes: 1 });
    ...
    /* src/components/ErrorPage.svelte generated by Svelte v3.30.0 */
    const file$7 = "src/components/ErrorPage.svelte";
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "button-container svelte-1884gnu");
    			add_location(div, file$7, 23, 4, 780);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$8(ctx) {
    	...
    	let t4;
    	let current;
    	let if_block = /*showButton*/ ctx[3] && create_if_block$3(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			if (if_block) if_block.c();
    			if (img.src !== (img_src_value = "/images/" + /*imageName*/ ctx[0] + ".svg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Ilustración de error");
    			attr_dev(img, "class", "svelte-1884gnu");
    			add_location(img, file$7, 19, 2, 616);
    			attr_dev(h2, "class", "products-page--page-title svelte-1884gnu");
    			add_location(h2, file$7, 20, 2, 683);
    			attr_dev(p, "class", "svelte-1884gnu");
    			add_location(p, file$7, 21, 2, 736);
    			attr_dev(div, "class", "svelte-1884gnu");
    			add_location(div, file$7, 18, 0, 608);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*imageName*/ 1 && img.src !== (img_src_value = "/images/" + /*imageName*/ ctx[0] + ".svg")) {
    				attr_dev(img, "src", img_src_value);
    			}

    			if (/*showButton*/ ctx[3]) if_block.p(ctx, dirty);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(if_block);
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	let { message } = $$props;
    	let code = message.split(errorSeparator$1)[0];
    	let title = message.split(errorSeparator$1)[1] || "Error";
    	let description = message.split(errorSeparator$1)[2] || "Error";
    	let imageName = "warning";
    	if (code === "404") imageName = "not-found"; else if (code === "204") imageName = "no-data"; else if (code === "001") imageName = "taken";
    	const showButton = code === "404" || code === "001" ? true : false;
    	const navigate = useNavigate();
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("imageName" in $$props) $$invalidate(0, imageName = $$props.imageName);
    	};
    	...
    	return [imageName, title, description, showButton, navigate, message, click_handler];
    }

    class ErrorPage extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { message: 5 });
    		...
    		if (/*message*/ ctx[5] === undefined && !("message" in props)) {
    			console.warn("<ErrorPage> was created without expected prop 'message'");
    		}
    	}
    ...
    const file$8 = "src/Products/components/ProductsList.svelte";
    ...
    function create_catch_block(ctx) {
    	...
    	errorpage = new ErrorPage({
    			props: { message: /*error*/ ctx[9].message },
    			$$inline: true
    		});
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "products-page--page-title");
    			add_location(h2, file$8, 39, 2, 1820);
    			attr_dev(div, "class", "svelte-ejf4c2");
    			add_location(div, file$8, 40, 2, 1893);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({
    		...
    		useFocus,
    		registerFocus,
    		errorSeparator: errorSeparator$2,
    		loadProducts,
    		sortProducts,
    		sortedProducts
    	});
    ...
    const file$9 = "src/Products/components/SingleProduct.svelte";
    ...
    function create_then_block$1(ctx) {
    	let h2;
    	let t0_value = /*product*/ ctx[4].title + "";
    	let t0;
    	let registerFocus_action;
    	let t1;
    	let div4;
    	...
    	let t4;
    	let p1;
    	let t5_value = /*product*/ ctx[4].description + "";
    	let t5;
    	let t6;
    	let div1;
    	let p2;
    	let t8;
    	let p3;
    	let t9_value = /*product*/ ctx[4]._id + "";
    	let t9;
    	let t10;
    	let div2;
    	let i;
    	...
    	let span;
    	let small;
    	let t13_value = /*product*/ ctx[4].price + "";
    	let t13;
    	let t14;
    	let button;
    	let current;
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(button.$$.fragment);
    			attr_dev(h2, "class", "products-page--page-title");
    			add_location(h2, file$9, 33, 2, 968);
    			if (img.src !== (img_src_value = `${API}/${/*product*/ ctx[4].imagePath}`)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", img_alt_value = /*product*/ ctx[4].title);
    			attr_dev(img, "class", "svelte-w9pygn");
    			add_location(img, file$9, 36, 6, 1091);
    			add_location(section0, file$9, 35, 4, 1075);
    			attr_dev(p0, "class", "title svelte-w9pygn");
    			add_location(p0, file$9, 42, 10, 1277);
    			attr_dev(p1, "class", "description svelte-w9pygn");
    			add_location(p1, file$9, 43, 10, 1320);
    			attr_dev(div0, "class", "group svelte-w9pygn");
    			add_location(div0, file$9, 41, 8, 1247);
    			attr_dev(p2, "class", "title svelte-w9pygn");
    			add_location(p2, file$9, 47, 10, 1423);
    			attr_dev(p3, "class", "description id svelte-w9pygn");
    			attr_dev(p3, "role", "button");
    			attr_dev(p3, "title", "Haz click para copiar el ID");
    			add_location(p3, file$9, 48, 10, 1457);
    			attr_dev(div1, "class", "group svelte-w9pygn");
    			add_location(div1, file$9, 46, 8, 1393);
    			attr_dev(i, "class", "bx bxs-coin svelte-w9pygn");
    			add_location(i, file$9, 58, 10, 1701);
    			add_location(small, file$9, 59, 16, 1743);
    			add_location(span, file$9, 59, 10, 1737);
    			attr_dev(div2, "class", "group price svelte-w9pygn");
    			add_location(div2, file$9, 57, 8, 1665);
    			attr_dev(div3, "class", "details svelte-w9pygn");
    			add_location(div3, file$9, 40, 6, 1217);
    			attr_dev(section1, "class", "details-container svelte-w9pygn");
    			add_location(section1, file$9, 39, 4, 1175);
    			attr_dev(div4, "class", "container svelte-w9pygn");
    			add_location(div4, file$9, 34, 2, 1047);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    			append_dev(h2, t0);
    			...
    			if (!mounted) {
    				dispose = [
    					action_destroyer(registerFocus_action = /*registerFocus*/ ctx[0].call(null, h2)),
    					listen_dev(p3, "click", /*copyID*/ ctx[2], false, false, false)
    				];
    ...
    // (31:16)    <Loader text="Cargando tu producto" /> {:then product}
    function create_pending_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(31:16)    <Loader text=\\\"Cargando tu producto\\\" /> {:then product}",
    		ctx
    	});
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<SingleProduct> was created with unknown prop '${key}'`);
    	});
    	...
    	return [registerFocus, promise, copyID, id];
    }

    class SingleProduct extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$a, create_fragment$a, safe_not_equal, { id: 3 });
    		...
    		if (/*id*/ ctx[3] === undefined && !("id" in props)) {
    			console_1.warn("<SingleProduct> was created without expected prop 'id'");
    		}
    	}
    ...
    /* src/Products/components/Cart.svelte generated by Svelte v3.30.0 */

    const file$a = "src/Products/components/Cart.svelte";
    ...
    // (7:0) <Route meta={{ viewName: 'página no encontrada' }}>
    function create_default_slot$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(7:0) <Route meta={{ viewName: 'página no encontrada' }}>",
    		ctx
    	});
    ...
    function create_fragment$c(ctx) {
    	...
    	route = new Route({
    			props: {
    				meta: { viewName: "página no encontrada" },
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	const message = `001${errorSeparator}¡Estamos perdidos!${errorSeparator}Parece que nos has solicitado una página que no existe. Haz click en el botón  para darte una vuelta por nuestro catálogo y hacer tu primera compra con nosotros.`;
    	const writable_props = [];
    ...
    const file$b = "src/Products/Products.svelte";
    ...
    function create_default_slot$4(ctx) {
    	...
    	pagenotfound = new PageNotFound({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-pzfzgy");
    			add_location(div, file$b, 12, 2, 381);
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div, t3);
    			mount_component(pagenotfound, div, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    		...
    		d: function destroy(detaching) {
    			...
    			destroy_component(pagenotfound);
    		}
    	};
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a2 = element("a");
    			a2.textContent = "Samuel Marroquín G.";
    			...
    			add_location(a2, file$c, 53, 4, 1522);
    			attr_dev(section1, "class", "developer-credits svelte-1ood148");
    			add_location(section1, file$c, 48, 2, 1327);
    			attr_dev(footer, "class", "svelte-1ood148");
    			add_location(footer, file$c, 35, 0, 965);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(i1, "click", /*showWhatsAppNumber*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    // (9:0) <Router a11y={{ createAnnouncement }}>
    function create_default_slot$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-1pepd6a");
    			add_location(div, file$d, 9, 2, 397);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(route0, div, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(9:0) <Router a11y={{ createAnnouncement }}>",
    		ctx
    	});
